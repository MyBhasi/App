...
<g:hiddenField name="id" value="${id}" />
    ...
    <div class="form-group ">
        ...
        <input type="text" class="form-control" id="exampleInputAmount" name="landMark"
               placeholder="Enter landMark" value="${officeCO?.landMark}">

        <g:hasErrors field="landMark" bean="${officeCO}">
            <g:fieldError field="landMark" bean="${officeCO}"></g:fieldError>
        </g:hasErrors>
    </div>
